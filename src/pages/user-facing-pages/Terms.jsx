      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed text-sm sm:text-base">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 text-xs sm:text-sm">
              <li>
                Users must ensure the accuracy of their personal information and
                mobile number provided during registration.
              </li>
              <li>
                Users must not misuse or manipulate the Program through any
                automated or fraudulent means.
              </li>
              <li>
                Users shall not sell, transfer or assign their loyalty points or
                benefits to others.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm">
              7.2. In the event of Program termination, Users will be provided
              with a reasonable period to redeem remaining points before they
              are forfeited.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 text-xs sm:text-sm mb-2">
              ...
              <li>
                Data may be shared with third-party partners solely for the
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm">
              10.1. These Terms and Conditions shall be governed by the laws of
              the Sultanate of Oman.
            </p>
            <p className="text-xs sm:text-sm">
              10.2. Any disputes arising under or in connection with these Terms
